...
public sealed class DeniaHappyBirthday : CustomCardModel
{
    ...
    public override List<(string, string)>? Localization => new CardLoc(Title: "生日快乐", Description: "所有我方人物获得{IfUpgraded:show:50|30}层[gold]聚爆轨迹[/gold]。");
    protected override async Task OnPlay(PlayerChoiceContext ctx, CardPlay play)
    {
        ...
        foreach (var player in combatState.Players)
            await PowerCmd.Apply<AemeathFusionBurstTrajectoryPower>(ctx, player.Creature, amount, Owner.Creature, this);
    }
