...
/// <summary>
/// 我回来了！ — Ancient Skill. 仅由 Archaic Tooth 从"请您不要···"转化而来。
/// autoAdd:false 不入随机池；showInCardLibrary:true 图鉴可见。
/// 与 AemeathShiningEnstage 同定位，参数一致。
/// </summary>
public sealed class DeniaImBack : DeniaCard
{
    public override string PortraitPath =>
        "res://images/packed/card_portraits/denia/card_face_i_am_back.png";
