...
public sealed class DeniaCurtainEnd : DeniaCard
{
    ...
    public override List<(string, string)>? Localization => new CardLoc(Title: "帷幕终景", Description: "选择一张手牌，将其复制品放入[gold]抽牌堆[/gold]。复制品获得[gold]消耗[/gold]{IfUpgraded:show:|、[gold]虚无[/gold]}。");
